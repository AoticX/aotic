...
* [cite_start]**50% Advance Rule**: The system enforces a minimum 50% advance payment before a job card can be created[cite: 46]. [cite_start]This can only be overridden by a Manager, and the override must include a documented reason and be audit-logged[cite: 47].
...
* [cite_start]**Mandatory Photos**: Technicians must upload a minimum of 4 photos and include at least one photo in each stage (before, during, and after) for every job[cite: 61, 208, 707].
